<div x-data="app()" style="position: absolute" x-cloak>
    <div class="mx-auto">
        <div class="flex items-center">
            <div>
                <input type="hidden" id="colorId" name="colorId" x-model="colorIndex">
                <input id="grid-color" type="text" placeholder="Pick a color"
                    class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
                    readonly x-model="colorSelected">
            </div>
            <div class="relative ml-3" style="margin-top: -10px">
                    ...
                    <div class="rounded-md bg-white shadow-xs px-4 py-3">
                        ...
                        <template x-for="(color, index) in colors" :key="index">
                            <div 
                                ...
                                <template x-if="colorSelected != color">
                                    <div
                                        @click="colorSelected = color, getColorName(index)"
            ...
            <span>
                <p class="appearance-none block w-full text-gray-700 py-3 px-4 mb-3 leading-tight" x-html="[selectedColorName + ' - ' + colorIndex]"></p>
            </span>
        </div>
    </div>
</div>
